...
net = pickle.load(archivo_lectura, encoding='latin1')
archivo_lectura.close()

print(type(net))  # Esto te dirá si es una tupla, un objeto o algo más
print(net)  # Imprime el contenido para saber qué contiene 'net'
